        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    total_ads = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ad_category_id = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    SecondaryImages = table.Column<string>(type: "text", nullable: true),
                    keywords = table.Column<string>(type: "text", nullable: true),
                    hierarchy = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ads_ad_categories_ad_category_id",
                        column: x => x.ad_category_id,
                        principalTable: "ad_categories",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ads_AspNetUsers_user_id",
                        column: x => x.user_id,
            ...
            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName", "status_id" },
                values: new object[,]
                {
                    { 1L, "40f041e6-47d9-4b5e-95ff-f7b92737084b", "ADM", "ADM", 1 },
                    { 2L, "1529670b-5147-4e68-a608-a0ee15d89a4e", "SUP", "SUP", 1 },
                    { 3L, "ca7d508b-5db1-457d-8687-7b652af9cc3a", "ADS", "ADS", 1 },
                    { 4L, "cbece01d-ec66-4004-8b5b-97bafb0b74f9", "GRL", "GRL", 1 }
                });

            migrationBuilder.CreateIndex(
                name: "IX_ads_ad_category_id",
                table: "ads",
