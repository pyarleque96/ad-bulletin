        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var baseUrlApp = $"{Request.Scheme}://{Request.Host}";

                    await _emailService.SendEmail(String.Empty,
                                          new List<string> { Input.Email },
                                          $"Welcome to {Constants.System.App.Title}",
                                          Constants.Email.EmailTemplates.Welcoming,
                                          new Dictionary<string, string>
                                          {
                                                ...
                                                { "{TitleApp}", Constants.System.App.Title},
                                                { "{Year}", "2024" }});
